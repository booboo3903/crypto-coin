...
bool AppInit2(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("--help"))
    {
        string strUsage = string() +
          ...
          _("Usage:") + "\t\t\t\t\t\t\t\t\t\t\n" +
            "  FreeDomd [options]                   \t  " + "\n" +
            "  FreeDomd [options] <command> [params]\t  " + _("Send command to -server or FreeDomd") + "\n" +
            "  FreeDomd [options] help              \t\t  " + _("List commands") + "\n" +
            "  FreeDomd [options] help <command>    \t\t  " + _("Get help for a command") + "\n" +
          _("Options:") + "\n" +
            "  -conf=<file>     \t\t  " + _("Specify configuration file (default: bitcoin.conf)") + "\n" +
            "  -pid=<file>      \t\t  " + _("Specify pid file (default: FreeDomd.pid)") + "\n" +
